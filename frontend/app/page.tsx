  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen overflow-hidden transition-colors duration-300 ${
        ...
        {/* Venture Navbar */}
        <VentureNavbar theme={theme} onToggleTheme={toggleTheme} currentPath="/" />

      {/* Hero Section - Venture style with WebGL background */}
      <section className={`relative min-h-screen flex items-center justify-center pt-32 overflow-hidden transition-colors ${
        ...
        {theme === 'light' && (
          <>
            ...
            <div className="absolute top-[40%] right-[10%] w-[800px] h-[800px]" style={{
              background: 'radial-gradient(circle, rgba(251, 146, 60, 0.2) 0%, rgba(252, 211, 77, 0.12) 35%, rgba(254, 240, 138, 0.06) 60%, transparent 80%)',
              filter: 'blur(80px)'
            }} />
        ...
        <div className={`absolute top-[20%] right-[5%] z-[2] hidden lg:block transition-opacity ${
          theme === 'light' ? 'opacity-90' : 'opacity-100'
        }`} style={{
          filter: theme === 'light' ? 'drop-shadow(0 0 20px rgba(60, 60, 60, 0.3))' : 'none'
        }}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className={`inline-flex border px-4 py-2 transition-colors ${
                theme === 'light'
                  ? 'border-black/20 bg-white'
                  : 'border-white/10 bg-black/40 backdrop-blur-sm'
              }`}>
                <span className={`relative text-[10px] uppercase tracking-wider font-mono ${
                  theme === 'light' ? 'text-gray-600' : 'text-gray-400'
                }`} style={{
                  textShadow: theme === 'light'
                    ? '0 0 20px rgba(251, 146, 60, 0), 0 0 40px rgba(252, 211, 77, 0)'
                    : '0 0 20px rgba(251, 146, 60, 0), 0 0 40px rgba(252, 211, 77, 0)',
                  animation: theme === 'light' ? 'text-glow-light 3s ease-in-out infinite' : 'text-glow-dark 3s ease-in-out infinite'
                }}>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.1] tracking-tight">
                Build transparent <span className="font-normal">reputation systems,</span>
                <br />
              ...
              <p className={`text-lg md:text-xl leading-relaxed max-w-3xl ${
                ...
                DotRepute is a <span className={`font-medium ${
                  theme === 'light' ? 'text-black' : 'text-white'
                }`}>Rust-powered Contributor Reputation System</span> for the Polkadot ecosystem.
                Aggregating identity, governance, staking, and activity signals to generate transparent, verifiable, and user-centric reputation scores.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                >
                  <span className={`relative z-10 text-sm uppercase tracking-wider font-medium transition-colors ${
                    theme === 'light'
            ...
            >
              ...
              <div className={`border p-6 transition-colors ${
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold uppercase tracking-tight">DotRepute Core</h3>
                </div>
              ...
              <div className={`border p-6 transition-colors ${
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold uppercase tracking-tight">DotRepute Indexer</h3>
                </div>
                <p className={`text-xs font-mono leading-relaxed ${
                  theme === 'light' ? 'text-gray-700' : 'text-gray-400'
                }`}>
      ...
      <section id="features" className={`relative py-24 border-t transition-colors ${
        ...
        <div className="mx-auto px-8">
          ...
          >
            ...
            <p className={`text-sm max-w-2xl uppercase tracking-wide font-mono ${
              theme === 'light' ? 'text-gray-600' : 'text-gray-400'
            }`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className={`h-full border p-6 transition-colors ${
                  theme === 'light'
                    ? 'border-black/10 bg-white hover:border-black/20'
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    {feature.icon}
                    <h3 className="text-base font-bold uppercase tracking-tight">{feature.title}</h3>
                  </div>
                  ...
                  {feature.highlights && (
                    <ul className="space-y-2">
                      {feature.highlights.map((highlight, i) => (
                        <li key={i} className={`text-[10px] flex items-start gap-2 font-mono uppercase tracking-wider ${
      ...
      <section id="tech" className={`relative py-24 border-t transition-colors ${
        theme === 'light' ? 'border-black/5' : 'border-white/5'
      }`}>
        <div className="mx-auto px-8">
          <motion.div
            ...
            {techStack.map((tech, index) => (
              ...
              >
                <div className={`border p-6 transition-colors ${
                  ...
                  <div className={`text-[10px] font-medium uppercase tracking-wider mb-4 font-mono ${
                    theme === 'light' ? 'text-gray-600' : 'text-gray-500'
                  }`}>
                    {tech.category}
                  </div>
      ...
      <section id="how-it-works" className={`relative py-24 border-t transition-colors ${
        theme === 'light' ? 'border-black/5' : 'border-white/5'
      }`}>
        <div className="mx-auto px-8">
          <motion.div
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">How It Works</h2>
            <p className={`text-sm uppercase tracking-wide font-mono max-w-2xl ${
              theme === 'light' ? 'text-gray-600' : 'text-gray-400'
            }`}>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-7 gap-6">
            {workflow.map((step, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.05 }}
              >
                <div className={`border p-6 h-full transition-colors ${
                  theme === 'light'
                    ? 'border-black/10 bg-white'
                    : 'border-white/10 bg-black'
                }`}>
                  ...
                  <h3 className="text-sm font-bold uppercase tracking-tight mb-3">{step.title}</h3>
      ...
      <section id="team" className={`relative py-24 border-t transition-colors ${
        theme === 'light' ? 'border-black/5' : 'border-white/5'
      }`}>
        <div className="mx-auto px-8">
          <motion.div
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight">Built by Experts</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className={`border p-8 transition-colors ${
                theme === 'light'
                  ? 'border-black/10 bg-white'
                  : 'border-white/10 bg-black'
              }`}>
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold uppercase tracking-tight mb-2">Aditya</h3>
            ...
            >
              <div className={`border p-8 transition-colors ${
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold uppercase tracking-tight mb-2">Steven Muanigo</h3>
      ...
      <section className={`relative py-24 border-t transition-colors ${
        theme === 'light' ? 'border-black/5' : 'border-white/5'
      }`}>
        <div className="mx-auto px-8">
          <motion.div
          ...
          >
            <div className={`border p-12 md:p-16 transition-colors ${
              theme === 'light'
                ? 'border-black/10 bg-white'
                : 'border-white/10 bg-black'
            }`}>
              <div className={`text-[10px] uppercase tracking-wider font-mono mb-6 text-center ${
                theme === 'light' ? 'text-gray-600' : 'text-gray-500'
              }`}>
                Get Started
              </div>
              ...
              <p className={`text-sm uppercase tracking-wide font-mono mb-12 max-w-2xl mx-auto text-center ${
                theme === 'light' ? 'text-gray-600' : 'text-gray-400'
              }`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <div className="flex items-center justify-center gap-2">
                    <span className="text-sm uppercase tracking-wider font-medium">Get Started</span>
                ...
                >
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-sm uppercase tracking-wider font-medium">View on GitHub</span>
                  </div>
                </a>
              </div>
            </div>
        ...
        <div className="mx-auto px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-8">
              ...
              <div className={`hidden md:flex flex-col text-[10px] uppercase tracking-wider font-mono ${
                theme === 'light' ? 'text-gray-600' : 'text-gray-500'
              }`}>
            ...
            <div className="flex items-center gap-6">
              ...
              <span className={theme === 'light' ? 'text-gray-400' : 'text-gray-700'}>|</span>
...
const features = [
  {
    ...
    description: 'Core scoring logic implemented in Rust with comprehensive weighted metrics, time decay, and modular architecture.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Comprehensive blockchain data indexing for identity, governance, staking, and activity events.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Multi-source identity verification with Sybil protection and gradual trust level system.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Enterprise-grade data quality engine with validation, normalization, and anomaly detection.',
    highlights: [
      'Type validation',
  ...
  },
  {
    ...
    description: 'Extensible trait-based design allowing easy integration of custom metrics and scoring algorithms.',
    highlights: [
      'Plugin system',
  ...
  },
  {
    ...
    description: 'All scoring logic is open-source and verifiable, with on-chain attestation support via ink! contracts.',
    highlights: [
      'Open-source scoring',
      'On-chain proofs',
...
const workflow = [
  {
    title: 'User Input',
    description: 'User requests reputation data for an address or interacts with the system'
  },
  {
    title: 'Intent Recognition',
    description: 'Backend/Frontend parses the request and determines required data'
  },
  {
    title: 'Validation',
    description: 'Check if additional parameters are needed (address format, date ranges, etc.)'
  },
  {
    title: 'Data Collection',
    description: 'Query SubQuery indexer for on-chain data, fetch from cache (Redis) if available, retrieve from Rust scoring engine'
  },
  {
    title: 'Score Calculation',
    description: 'Rust modules process data through scoring algorithms with time decay and weighted metrics'
  },
  {
    title: 'Response Generation',
    description: 'Format results with breakdown, badges, levels, and component scores'
  },
  {
    title: 'Delivery',
    description: 'Return JSON/GraphQL response or render UI components for the user'
  }
];
