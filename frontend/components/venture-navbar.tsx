...
import { ConnectButton, useConnectModal, useLunoTheme } from "@luno-kit/ui";
      ...
      <div className="mx-auto px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <Link href="/">
              <div
                className={`border px-4 py-3 transition-colors cursor-pointer hover:border-opacity-40 ${
                  theme === "light"
            ...
            <div
              className={`hidden lg:flex flex-col text-[10px] uppercase tracking-wider font-mono ${
          ...
          <div className="flex items-center gap-4">
            ...
            {showAuthButtons && !isLoggedIn && (
              <>
                ...
                <ConnectButton
                  ...
                  className="uppercase luno:border luno:border-[#000000] luno:text-xs luno:tracking-wider luno:font-medium luno:min-h-[36px] min-h-[36px]"
                />
              </>
            )}
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`md:hidden border px-3 ${
                theme === "light"
